...
class Flames:
    ...
    def __init__(self):
        self.flames = pygame.image.load('nomon.png')
        self.flames_img = pygame.transform.scale(self.flames, (100, 100))
...
def game_over():
    ...
    music = pygame.mixer.Sound('ends.wav')
    music.play()
    topscore.top_score(SCORE)
    game_over_img = pygame.image.load('ends.png')
...
def start_game():
    canvas.fill(BLACK)
    start_img = pygame.image.load('starts.png')
